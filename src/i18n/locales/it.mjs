...
export default {
  ...
  'clue.giornale_1952.desc':
    'Un articolo ingiallito: "Sparizione misteriosa alla cascina Bellandi. Le autorità brancolano nel buio".',
  'clue.cronaca_parrocchiale.name': 'Cronaca parrocchiale del 1861',
  'clue.cronaca_parrocchiale.desc':
    '"I Visitatori della Mietitura sono tornati. Il cielo arde di un azzurro innaturale".',
  'clue.verbale_carabinieri.name': 'Verbale Carabinieri 1974',
  'clue.verbale_carabinieri.desc':
    'Rapporto di pattuglia: "Avvistate sfere luminose sopra il bosco. Interferenze radio impediscono le comunicazioni".',
  'clue.appunti_enzo_2.name': 'Appunti stropicciati di Enzo',
  'clue.appunti_enzo_2.desc':
    'Disegni di costellazioni e una parola ripetuta: "Apertura". Segna una data: 21 Luglio.',
  'clue.registro_comunale.name': 'Registro Comunale Censito',
  'clue.registro_comunale.desc':
    'Mancano diverse pagine tra il 1960 e il 1962. Qualcuno ha cercato di nascondere dei dati.',
  'clue.nastro_monte_ferro_2.name': 'Nastro Monte Ferro — Sequenza 4',
  'clue.nastro_monte_ferro_2.desc':
    '"Coordinate sintonizzate... il segnale risponde... pronti per l\'impulso finale".',

  'clue.menta.name': 'Menta Selvatica',
  'clue.menta.desc':
    'Un mazzetto di menta selvatica profumatissima. Cresce solo vicino ai cerchi nel grano dei Giardini.',
  'clue.lettera_gino.name': 'Lettera smarrita di Gino',
  'clue.lettera_gino.desc':
    "Una busta gialla con timbro postale. Gino l'ha persa durante il giro di consegne.",
  'clue.testim_tracce.name': 'Testimonianza sulle tracce',
  'clue.testim_tracce.desc':
    '"Ho visto le impronte quella notte. Non erano di un uomo. Erano... diverse."',
  'object.gatto_piazze': 'Gatto randagio',

  // Ipotesi
  'hypo.esperimento_militare.name': 'Operazione Radar 1961',
  'hypo.esperimento_militare.desc':
    'Le luci del 1961 erano parte di un esperimento radar coperto dal Ministero.',
  'hypo.rapimento_ciclico.name': 'Il Patto del Silenzio',
  'hypo.rapimento_ciclico.desc':
    'Le sparizioni seguono ricorrenze irregolari, sempre più ravvicinate. Enzo non è il primo.',
  ...
  'hypo.falle_dimensionali.desc':
    'Le cronache antiche e gli appunti di Enzo coincidono: le luci non "vengono", ma si "aprono" in date precise.',
  'hypo.complotto_comunale.name': 'Infiltrazione Istituzionale',
  'hypo.complotto_comunale.desc':
    "Il Comune ha attivamente rimosso dati sulle sparizioni per coprire l'Operazione Sirius.",
  'hypo.segnale_risposta.name': 'Contatto Radio Attivo',
  'hypo.segnale_risposta.desc':
    'I nastri di Monte Ferro confermano che stavano inviando un segnale. La radio del bar ha captato la risposta.',
  ...
  'dialogue.ruggeri_s5_complotto.text':
    'Siete arrivato a frugare nei registri comunali? Ispettore, vi consiglio di non scavare troppo a fondo. Certe omissioni sono state fatte per il bene del paese, per evitare il panico.',
  ...
  'dialogue.ruggeri_s5_sirio.text':
    'Sirius... quel nome non dovrebbe essere sulla bocca di un civile. Se sapete questo, allora sapete che non posso aiutarvi oltre. Fate attenzione a dove camminate di notte.',
  'dialogue.valli_s3_segnale.text':
    "Quindi avete trovato i nastri. Sì, eravamo noi a trasmettere. Ma non ci aspettavamo una risposta. Quello che è arrivato da lassù... ha mandato in corto circuito l'intera stazione radar.",
  ...
  'dialogue.valli_s3_negazione.text':
    'Non nego nulla. Ordini superiori. "Procurare il silenzio", questo era il mio compito. Ma Enzo... Enzo non doveva essere lì.',
  'dialogue.valli_s3_colpa.text':
    'La colpa è un lusso che non mi permetto, Ispettore. Abbiamo giocato con frequenze che non comprendevamo. Ora il segnale è aperto.',
  'dialogue.don_pietro_s2_falle.text':
    'Le cronache del 1861 parlavano della "Mietitura". Gli antichi sapevano che il cielo si apre quando la terra è pronta. Voi la chiamate scienza, io lo chiamo il Giorno del Giudizio.',
  ...
  'dialogue.don_pietro_s2_fermare.text':
    'Non si ferma il mare con le mani, né il cielo con le preghiere di chi non crede. Si può solo testimoniare.',
  'dialogue.don_pietro_s2_enzo.text':
    'Egli è nella luce ora. O forse la luce è in lui. Preghiamo per la sua anima, Ispettore.',
  'dialogue.teresa_s3_ciclo.text':
    'I segni sul portone... Enzo li aveva disegnati identici nel suo diario. Egli sapeva che le luci lo avrebbero chiamato. È il ciclo che si ripete, come diceva mio nonno.',

  // Nuovi Nodi Trust-Gated
  'dialogue.neri_s3_confessione.text':
    "Va bene, Maurizio. Avete vinto. Ero io il consulente scientifico del Progetto Sirius nel '61. Pensavamo di poter controllare l'apertura. Ma abbiamo solo attirato la loro attenzione.",
  ...
  'dialogue.neri_s3_perche.text':
    'Perché vedo in voi la stessa curiosità che mi ha rovinato. Non fate i miei stessi errori.',
  'dialogue.neri_s3_falla.text':
    'Non si può chiudere. Si può solo aspettare che il ciclo finisca. Ma portate questo con voi, vi aiuterà a capire le frequenze.',
  'dialogue.osvaldo_s3_fiducia.text':
    'Ispettore, vi siete comportato bene con me. Vi darò una cosa che ho trovato dietro il bancone anni fa. È una chiave con un simbolo che ho visto solo nel Campo delle Luci.',
  'dialogue.gino_s3_testimone.text':
    "Quella notte del '74... ero io di pattuglia per le consegne notturne. Ho visto una sfera scendere sopra la chiesa. Non era un aereo. Si muoveva come... come se il tempo non esistesse.",
  'dialogue.don_pietro_s3_segreto.text':
    'Sotto l\'altare c\'è una cripta che risale al 1600. Lì sono conservati i resti di chi "partì" durante la Grande Mietitura. Se volete sapere la verità, dovete guardare nel passato.',
