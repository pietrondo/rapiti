...
export function render(ctx) {
  ...
  if (ph === 'title') { SceneRenderer.renderTitle(ctx); }
  else if (ph === 'prologue_cutscene') { SceneRenderer.renderPrologueCutscene(ctx); }
  else if (ph === 'intro') { SceneRenderer.renderIntroSlide(ctx); }
  else if (ph === 'prologue') { SceneRenderer.renderPrologue(ctx); }
  else if (ph === 'tutorial') { SceneRenderer.renderTutorial(ctx); }
  ...
  else if (ph === 'ending') { SceneRenderer.renderEndingScreen(ctx); }
  if (ph === 'customize') { SceneRenderer.renderTitle(ctx); }
